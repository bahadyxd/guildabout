 ...
 * @version 1.1.1
 * @author Bahady (Baha Demir)
 * @authorId 768466007610097734
 * @invite M2PyUB7DCN
 * @website https://www.bahadythedeveloper.cf
 * @source https://raw.githubusercontent.com/bahadyxd/guildabout/main/guildabout.plugin.js
 * @updateUrl https://raw.githubusercontent.com/bahadyxd/guildabout/main/guildabout.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {"info":{"name":"GuildAbout","description":"Adds a modal that can be opened via any guild menu and contains various information about the guild, such as its owner, creation date, joined date, your friends and blocked users who are in it, and much more.","version":"1.1.1","authors":[{"name":"Bahady (Baha Demir)","discord_id":"768466007610097734"}],"github":"https://github.com/bahadyxd/guildabout","github_raw":"https://raw.githubusercontent.com/bahadyxd/guildabout/main/guildabout.plugin.js"},"changelog":[{"title":"It broke again","type":"fixed","items":["Fixed broken layout due to discord latest update."]}]};
...
"use strict";
module.exports = JSON.parse('{"GUILD_PROFILE":"Server Profile","GUILD_PROFILE_GUILD_INFO":"Server Info","GUILD_PROFILE_FRIENDS_IN_GUILD":"Friends","GUILD_PROFILE_BLOCKED_USERS_IN_GUILD":"Blocked Users","GUILD_PROFILE_LOADING":"Loading","GUILD_PROFILE_CREATED_AT":"Created at","GUILD_PROFILE_JOINED_AT":"Joined at","GUILD_PROFILE_GUILD_PREMIUM_SUBSCRIBER_COUNT":"Server Booster Count","GUILD_PROFILE_GUILD_PREMIUM_TIER":"Server Boost Level","GUILD_PROFILE_NO_FRIENDS_IN_THIS_GUILD":"No friends in this server","GUILD_PROFILE_NO_BLOCKED_USERS_IN_THIS_GUILD":"No blocked users in this server","GUILD_PROFILE_INVITE_SPLASH":"Server Invite Background","GUILD_PROFILE_VIP_REGIONS":"VIP Regions","GUILD_PROFILE_VANITY_URL":"Vanity URL","GUILD_PROFILE_MORE_EMOJI":"More Emoji","GUILD_PROFILE_COMMERCE":"Store Channels","GUILD_PROFILE_DISCOVERABLE":"Discoverable","GUILD_PROFILE_COMMUNITY":"Community","GUILD_PROFILE_FEATURABLE":"Featurable","GUILD_PROFILE_NEWS":"Announcement Channels","GUILD_PROFILE_ANIMATED_ICON":"Animated Server Icon","GUILD_PROFILE_BANNER":"Server Banner","GUILD_PROFILE_ENABLED_DISCOVERABLE_BEFORE":"Enabled Discoverable Before","GUILD_PROFILE_WELCOME_SCREEN_ENABLED":"Welcome Screen Enabled","GUILD_PROFILE_MEMBER_VERIFICATION_GATE_ENABLED":"Membership Screening","GUILD_PROFILE_PREVIEW_ENABLED":"Preview Enabled"}');
...
;// CONCATENATED MODULE: ./src/GuildAbout/stores/MemberCountsStore.js
/* @license
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/GuildBanner.jsx
/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/invite-splash.svg
var _path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/vip-regions.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/vanity-url.svg
var vanity_url_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/more-emoji.svg
var more_emoji_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/commerce.svg
var commerce_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/discoverable.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/community.svg
var community_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/featurable.svg
var featurable_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/news.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/animated-icon.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/banner.svg
var banner_path;
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/enabled-discoverable-before.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/welcome-screen-enabled.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/member-verification-gate-enabled.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/preview-enabled.svg
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/features/index.js
/*@license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/GuildFeatures.jsx
/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
                ...
                return (
                    external_BdApi_React_default().createElement(TooltipContainer, { key: feature, text: i18n.Messages[`GUILD_PROFILE_${feature}`],}
                        , external_BdApi_React_default().createElement(Clickable, null
                            , external_BdApi_React_default().createElement(Icon, { className: `${GuildFeatures_classes.profileBadge24} feature`,} )
                        )
                    )
                );
            })
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/GuildTag.jsx
/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/GuildAboutModalHeader.jsx
/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
const { ContextMenuActions, ImageResolver: GuildAboutModalHeader_ImageResolver } = external_BoundedLibrary_namespaceObject.DiscordModules;
...
const GuildAboutModalHeader_classes = {
...
function MemberCounts({ guild }) {
    ...
    return (
        external_BdApi_React_default().createElement('div', { className: GuildAboutModalHeader_classes.invite.guildDetail,}
            , external_BdApi_React_default().createElement(InviteButton.Data, { members: members, membersOnline: membersOnline,} )
        )
    );
}

function GuildAboutModalHeader({ guild }) {
    const fullSizeIconURL = GuildAboutModalHeader_ImageResolver.getGuildIconURL({
        id: guild.id,
        icon: guild.icon,
        size: 1024,
        canAnimate: true
    ...
    return (
        external_BdApi_React_default().createElement('header', null
            ...
            , external_BdApi_React_default().createElement('div', { className: GuildAboutModalHeader_classes.profileHeader.header,}
                , external_BdApi_React_default().createElement(Avatar, {
                    className: GuildAboutModalHeader_classes.profileHeader.avatar,
                    src: guild.getIconURL(true),
                    size: Avatar.Sizes.SIZE_120,
                    onContextMenu: handleIconContextMenu,}
                )
                , external_BdApi_React_default().createElement('div', { className: `${GuildAboutModalHeader_classes.profileHeader.headerTop} header-top`,}
                    , guild.features.size > 0 && (
                        external_BdApi_React_default().createElement(GuildFeatures_GuildFeatures, { className: GuildAboutModalHeader_classes.profileHeader.badgeList, guild: guild,} )
                    )
                    , external_BdApi_React_default().createElement(MemberCounts, { guild: guild,} )
                )
            )
            , external_BdApi_React_default().createElement(GuildTag, {
                className: GuildAboutModalHeader_classes.profileHeader.nameTagNoCustomStatus,
                usernameClass: GuildAboutModalHeader_classes.profileHeader.username,
                guild: guild,}
            )
        )
    );
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/Relationships.jsx
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/GuildInfo.jsx
...
;// CONCATENATED MODULE: ./src/GuildAbout/components/GuildAboutModal/index.jsx
...
const {
    DiscordConstants: { RelationshipTypes: GuildAboutModal_RelationshipTypes }
} = external_BoundedLibrary_namespaceObject.DiscordModules;

const { ModalRoot } = external_BoundedLibrary_namespaceObject.WebpackModules.getByProps('ModalRoot');

const GuildAboutModal_classes = external_BoundedLibrary_namespaceObject.WebpackModules.getByProps('root', 'topSection', 'body');

const GuildAboutSections = {
    GUILD_INFO: 'GUILD_INFO',
    FRIENDS: 'FRIENDS',
    BLOCKED_USERS: 'BLOCKED_USERS'
};

class GuildAboutModal extends (external_BdApi_React_default()).PureComponent {
    constructor(props) {
        super(props);

        this.state = {
            selectedSection: _nullishCoalesce(props.section, () => ( GuildAboutSections.GUILD_INFO))
        };
    ...
    render() {
        ...
        return (
            external_BdApi_React_default().createElement(ModalRoot, { className: `${GuildAboutModal_classes.root} guild-profile`, transitionState: 1,}
                , external_BdApi_React_default().createElement('div', { className: GuildAboutModal_classes.topSection,}
                    , external_BdApi_React_default().createElement(GuildAboutModalHeader, { guild: guild,} )
                    , external_BdApi_React_default().createElement('div', { className: GuildAboutModal_classes.tabBarContainer,}
                        , external_BdApi_React_default().createElement(TabBar, {
                            className: GuildAboutModal_classes.tabBar,
                            type: TabBar.Types.TOP,
                            selectedItem: selectedSection,
                            onItemSelect: this.handleSectionSelect,}
                        
                            , external_BdApi_React_default().createElement(TabBar.Item, { className: GuildAboutModal_classes.tabBarItem, id: GuildAboutSections.GUILD_INFO,}
                                , i18n.Messages.GUILD_PROFILE_GUILD_INFO
                            )
                            , external_BdApi_React_default().createElement(TabBar.Item, { className: GuildAboutModal_classes.tabBarItem, id: GuildAboutSections.FRIENDS,}
                                , i18n.Messages.GUILD_PROFILE_FRIENDS_IN_GUILD
                            )
                            , external_BdApi_React_default().createElement(TabBar.Item, { className: GuildAboutModal_classes.tabBarItem, id: GuildAboutSections.BLOCKED_USERS,}
                                , i18n.Messages.GUILD_PROFILE_BLOCKED_USERS_IN_GUILD
                            )
                        )
                    )
                    , external_BdApi_React_default().createElement('div', { className: GuildAboutModal_classes.body,}, this.renderSelectedSection())
                )
            )
        );
    }
    ...
    renderSelectedSection() {
        ...
        switch (selectedSection) {
            case GuildAboutSections.FRIENDS:
                return external_BdApi_React_default().createElement(Relationships, { guild: guild, relationshipType: GuildAboutModal_RelationshipTypes.FRIEND,} );
            case GuildAboutSections.BLOCKED_USERS:
                return external_BdApi_React_default().createElement(Relationships, { guild: guild, relationshipType: GuildAboutModal_RelationshipTypes.BLOCKED,} );
            default:
...
;// CONCATENATED MODULE: ./src/GuildAbout/assets/guild-profile.svg
...
/* harmony default export */ const guild_profile = (SvgGuildAbout);
;// CONCATENATED MODULE: ./src/GuildAbout/style.scss
...
;// CONCATENATED MODULE: ./src/GuildAbout/locales/index.js
/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
/* harmony default export */ const GuildAbout_locales = (locales);

;// CONCATENATED MODULE: ./src/GuildAbout/index.jsx
 function GuildAbout_optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }/* @license
 * Copyright (c) 2021 jaimeadf (Jaime Filho)
 * Licensed under the Open Software License version 3.0
 */
...
const { ModalStack: GuildAbout_ModalStack, UserSettingsStore, SelectedGuildStore, GuildStore } = external_BoundedLibrary_namespaceObject.DiscordModules;

const Menu = external_BoundedLibrary_namespaceObject.WebpackModules.getByProps('MenuItem');

class GuildAbout extends (external_Plugin_default()) {
    constructor() {
        super();
    ...
    patchMenu() {
        external_BoundedLibrary_namespaceObject.Patcher.before(Menu, 'default', (thisObject, [{ navId, children }]) => {
            if (
                ...
                external_BoundedLibrary_namespaceObject.Utilities.findInReactTree(children, c => GuildAbout_optionalChain([c, 'optionalAccess', _ => _.id]) === 'guild-profile')
            ) {
                return;
            }
            ...
            children.unshift(
                external_BdApi_React_default().createElement(Menu.MenuGroup, null
                    , external_BdApi_React_default().createElement(Menu.MenuItem, {
                        ...
                        icon: guild_profile,
                        action: () => this.openGuildAboutModal(GuildStore.getGuild(SelectedGuildStore.getGuildId())),}
                    )
                )
            );
        });
    ...
    patchContextMenu() {
        const GuildContextMenu = external_BoundedLibrary_namespaceObject.WebpackModules.getModule(m => GuildAbout_optionalChain([m, 'optionalAccess', _2 => _2.default, 'optionalAccess', _3 => _3.displayName]) === 'GuildContextMenu');
            ...
            returnValue.props.children.splice(
                ...
                external_BdApi_React_default().createElement(Menu.MenuGroup, null
                    , external_BdApi_React_default().createElement(Menu.MenuItem, {
                        ...
                        key: "guild-profile",
                        label: i18n.Messages.GUILD_PROFILE,
                        action: () => this.openGuildAboutModal(guild),}
                    )
                )
            );
        });
    ...
    loadLocale() {
        Object.assign(i18n._proxyContext.messages, GuildAbout_locales[UserSettingsStore.locale]);
        Object.assign(i18n._proxyContext.defaultMessages, GuildAbout_locales["en-US"]);
    }

    openGuildAboutModal(guild) {
        GuildAbout_ModalStack.push(props => external_BdApi_React_default().createElement(GuildAboutModal, { ...props, guild: guild,} ));
    }
}
